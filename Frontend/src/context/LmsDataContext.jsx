...
export function LmsDataProvider({ children }) {
  ...
  const normalizeAssessment = (row) => {
    ...
    return {
      ...
      topicName: topicName || '',
      durationMinutes: Number(row.duration_minutes) || (row.eval_type === 'quiz' ? 45 : 20),
      totalMarks: Number(row.total_marks) || (row.eval_type === 'quiz' ? 100 : 10),
      mcqCount: mcqCount,
  ...
  const toDbAssessment = (a) => {
    ...
    return {
      ...
      duration_minutes: Number(a.durationMinutes !== undefined && a.durationMinutes !== '' ? a.durationMinutes : 20),
      total_marks: Number(a.totalMarks !== undefined && a.totalMarks !== '' ? a.totalMarks : 10),
