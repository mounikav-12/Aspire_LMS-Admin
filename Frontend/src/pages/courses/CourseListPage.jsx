            ...
            <BatchMultiSelectDropdown
              ...
              onChangeWeekdayBatches={(nextWd) => {
                ...
                if (viewingBatchesCourse) {
                  try { localStorage.setItem(`aspire_lms_card_wd_${viewingBatchesCourse.id}`, JSON.stringify(nextWd)); } catch (e) {}
                }
              }}
              onChangeWeekendBatches={(nextWe) => {
                setSelectedWeekendBatches(nextWe);
                if (viewingBatchesCourse) {
                  try { localStorage.setItem(`aspire_lms_card_we_${viewingBatchesCourse.id}`, JSON.stringify(nextWe)); } catch (e) {}
                }
              }}
            />
          </div>
